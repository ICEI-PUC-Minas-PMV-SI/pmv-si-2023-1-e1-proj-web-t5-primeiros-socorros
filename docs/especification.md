...
|RF-004| A aplicação deve permitir que o usuário cadastrado realize o login para que tenha acesso a funcionalidades específicas do site | ALTA | |
...
|RF-012| A aplicação deverá disponibilizar a recuperação da senha por meio da verificação do CPF do usuário cadastrado. | ALTA | |
...
|RF-015| A aplicação deve permitir que o usuário crie uma conta e edite seu cadastro. | ALTA | |
